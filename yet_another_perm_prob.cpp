...
void solve(int tc)
{
// We want to maximise sum i*pi - max j* pj
// Iterate over all the possible values fo j*pj
// If the max j*pj <= M
// Index of n can be at max j*n <= M
// j <= (M/n) so would place 
// maintain <= (M/1)
